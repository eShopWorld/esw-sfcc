...
var FileReaderMock = require('../../../../mocks/dw/io/FileReader');
...
describe('int_eshopworld_core/cartridge/scripts/helper/eswFileHelper.js', function () {
    var eswFileHelper = proxyquire('../../../../../cartridges/int_eshopworld_core/cartridge/scripts/helper/eswFileHelper', {
        ...
        'dw/io/FileReader': FileReaderMock
    }).eswFileHelper;
    describe("Success cases", function () {
        ...
        it("Should read file text", function () {
            var writeFileStr = eswFileHelper.readFile('IMPEX/src');
            expect(writeFileStr).to.equals(undefined);
        });
    });
});
