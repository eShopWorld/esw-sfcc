...
describe('int_eshopworld_core/cartridge/scripts/jobs/OrderStatus.js', function () {
    var orderStatusJob = proxyquire('../../../../../cartridges/int_eshopworld_core/cartridge/scripts/jobs/OrderStatus', {
    ...
    it('Should return ERROR status', function () {
        let fff = orderStatusJob.execute();
