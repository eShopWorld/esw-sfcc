...
describe('int_eshopworld_pwa/cartridge/scripts/helper/eswHelperHL.js', function () {
    ...
    // Unit test
    it('Returns Order Prorated Discount', function () {
    ...
    it('Returns getOrder Discount', function () {
        Basket.priceAdjustments = new ArrayList([{
            promotion: {
                promotionClass: 'awesome promotion',
                price: 10
    ...
    it('Returns Applied shipping method', function () {
    ...
    it('Returns product item metadata items', function () {
    ...
    it('Setup Basket currecy based on pricebook currency', function () {
    ...
    it('Returns Threshold Enabled', function () {
        let promotion = {
            custom: {
    ...
    it('Returns Discount Type', function () {
        let promotion = {
            custom: {
