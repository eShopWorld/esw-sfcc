...
describe('int_eshopworld_pwa/cartridge/scripts/helper/eswPwaCoreHelper.js', function () {
    var eswPwaCoreHelper = proxyquire('../../../../../cartridges/int_eshopworld_pwa/cartridge/scripts/helper/eswPwaCoreHelper', {
        ...
        '*/cartridge/scripts/helper/eswPricingHelper': {
            eswPricingHelper: {
                ...
                getConversionPreference: function () { return 'EUR'; }
            }
        },
        ...
        '*/cartridge/scripts/helper/eswTimeZoneHelper': {
            ...
            const tzCountry = timezones[timezone].c[0]; 7;
            return tzCountry;
            }
        },
    ...
    it('Modify product items', function () {
        const productItems = [{
            price: '',
            basePrice: '',
    ...
    it('returns promo code array', function () {
        const order = {};
    ...
    it('returns Country By TimeZone', function () {
        let countryByTimeZone = eswPwaCoreHelper.getCountryByTimeZone('Africa/Abidjan');
        expect(countryByTimeZone).to.be.an('string');
    });
    it('returns CustomerCustomObject', function () {
        let customerCustomObject = eswPwaCoreHelper.getCustomerCustomObject('test@gmail.com');
        expect(customerCustomObject).to.be.an('undefined');
    });
    it('returns PwaUrl', function () {
        let pwaUrl = eswPwaCoreHelper.getPwaUrl('');
        expect(pwaUrl).to.be.an('undefined');
    });
});
