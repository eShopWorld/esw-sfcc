...
test.describe('ESW PWA Checkout', () => {
    test('shopper Lands On homePage TO ESW Checkout Flow', async ({page}) => {
        ...
        await page
            .getByRole('link', {name: /Green and Brown Beaded Frontal Collar Bracelet/i})
            .click()
        ...
        // Continue to payment
        const continueToPaymentButton = await page.locator(
            'esw-button[customattribute="continue_to_payment_button_click_CTA"] button'
        )
