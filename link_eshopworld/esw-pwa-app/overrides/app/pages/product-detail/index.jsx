...
import {getIsInventoryAvailable} from '../../esw/esw-services'
...
const ProductDetail = () => {
    ...
    const handleAddToCart = async (productSelectionValues) => {
        console.log(productSelectionValues)
        try {
            ...
            let isMoEnabled = getEswConfigByKey('isEnabledMultiOrigin')
            let isInventoryAvailable = {
                success: true,
                message: null
            }
            if (isMoEnabled) {
                isInventoryAvailable = await getIsInventoryAvailable({productItems: productItems})
            }
            const response =
                isInventoryAvailable.success || !isMoEnabled
                    ? await addItemToNewOrExistingBasket(productItems)
                    : {c_MultiOriginProductAddUpdateError: isInventoryAvailable.message}
