...
const getEswHelper = {
    ...
    getPricingAdvisorData: function () {
        ...
        paCustomObj = this.getCustomObjectDetails('ESW_PA_DATA', 'ESW_PA_DATA');
    ...
    */
    setLocation: function (country) {
        ...
        if (selectedCountry && this.checkIsEswAllowedCountry(selectedCountry)) {
            currencyCode = !empty(request.httpCookies['esw.currency']) ? request.httpCookies['esw.currency'].value :
                this.getDefaultCurrencyForCountry(selectedCountry);
